...
def plot_and_save_losses(train_losses, val_losses, filename="resnet101_loss_curve.png"):
...
def plot_map_iou_curve(iou_thresholds, map_values, global_map, filename="resnet101_map_iou_curve.png"):
    ...
    # Remplir la zone sous la courbe pour faire p
    plt.fill_between(iou_thresholds, map_values, color='skyblue', alpha=0.3)
    
    # Tracer la ligne de la moyenne (le fameux mAP global)
    ...
    plt.title("Dégradation du mAP selon la sévérité de l'IoU: cas des pso", fontsize=14, fontweight="bold")
...
def plot_threshold_analysis(thresholds, precisions, recalls, f1_scores, best_threshold, filename="analyse_seuils_pso.png"):
    plt.figure(figsize=(10, 6))
