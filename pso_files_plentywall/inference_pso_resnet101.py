...
def main(model_path, image_test_path,seuil_salle,hauteur_fenetre_haut,hauteur_fenetre_bas):
    ...
    boites, _ = detect_pso(model, image_test_path, threshold=0.45, device=device)
...
if __name__ == "__main__":
    model_path = r"C:\Users\k.nguessan\Desktop\DocStage\DocStage\Codes\pso_files_plentywall\faster_pso_resnet101_best.pth"
    image_test_path = r"C:\Users\k.nguessan\Desktop\DocStage\DocStage\Codes\images_Test.jpg"
    ...
    hauteur_fenetre_haut =145
    hauteur_fenetre_bas =150
