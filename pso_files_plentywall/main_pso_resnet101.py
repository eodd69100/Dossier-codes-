...
def main(train_img, train_ann, val_img, val_ann):
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.4, patience=4) # mode='min' pour surveiller la perte de validation
    ...
    for epoch in range(num_epochs):
        #  Entraînement et récupération des 3 pertes
