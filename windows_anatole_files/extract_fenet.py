...
def main():
    print("="*50)
    print(" EXTRACTION AUTOMATIQUE DES FENÊTRES ")
    print("="*50)
    ...
    json_path = r"C:\Users\k.nguessan\Desktop\DocStage\DocStage\Codes\windows_anatole_files\detection_fenetre.v1i.coco\train\_annotations.coco.json"
    
    # Dossier où se trouvent tes images originales de façades
    img_folder = r"C:\Users\k.nguessan\Desktop\DocStage\DocStage\Codes\windows_anatole_files\detection_fenetre.v1i.coco\train\images"
    
    # Dossier où seront sauvegardés les PSOs découpés
    output_folder = r"C:\Users\k.nguessan\Desktop\DocStage\DocStage\Codes\fenetres_detourees"
    ...
    print(f"-> {len(data['annotations'])} fenêtres à extraire.")
