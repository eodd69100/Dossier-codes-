...
def plot_and_save_losses(train_losses, val_losses, filename="resnet101_fenet_anatole_loss_curve.png"):
...
def plot_precision_recall(map_dict, filename="resnet101_fenet_anatole_precision_recall.png"):
    ...
    plt.title("Métriques de Performance du Modèle: école anatole France")
...
def plot_threshold_analysis(thresholds, precisions, recalls, f1_scores, best_threshold, filename="analyse_seuils_fenetre_anatole.png"):
    plt.figure(figsize=(10, 6))
    ...
    plt.ylabel("Score")
    plt.title("Performances selon le seuil de confiance: cas des fenêtres anatole")
