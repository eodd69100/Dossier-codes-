...
from data_fenet import get_dataloaders
from model_fenet_resnet101 import create_model
from engine_fenet_resnet101 import train_one_epoch, evaluate_loss, evaluate_sweet_spot,evaluate_map_all_ious
from graph_fenet_resnet101 import plot_and_save_losses, plot_threshold_analysis
...
def main(train_img,train_ann,val_img,val_ann ):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            trigger_times = 0
            torch.save(model.state_dict(), "faster_fenet_anatole_resnet101_best.pth")
    ...
    model.load_state_dict(torch.load("faster_fenet_anatole_resnet101_best.pth"))
    ...
    from graph_fenet_resnet101 import plot_map_iou_curve
    plot_map_iou_curve(iou_threshs, map_vals, map_dict['map'].item(), "resnet101_anatole_map_iou_curve.png")
